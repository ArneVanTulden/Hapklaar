<div class="grid grid-cols-1 md:grid-cols-2 gap-4 [grid-auto-rows:1fr]">
    @foreach($recipe->steps as $step)
        <div class="bg-white border-2 border-black shadow-[3px_3px_0px_0px_#000] flex overflow-hidden cursor-pointer transition-all duration-150 hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none h-full"
            ...
            <div class="relative flex-shrink-0 w-24 self-stretch border-r-2 border-black">
