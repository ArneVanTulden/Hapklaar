                ...
                <div class="flex gap-6 items-start">
                    ...
                    <div class="flex-1 min-w-0 space-y-4">
                        ...
                        <div class="bg-white border-2 border-black shadow-[4px_4px_0px_0px_#000]">
                            <button class="w-full flex items-center justify-center gap-2 py-4 text-[11px] font-black uppercase tracking-widest text-gray-500 hover:bg-[var(--pink-soft)] transition-colors">
