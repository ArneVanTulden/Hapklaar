    ...
    <body class="m-0 bg-[var(--pink-soft)] min-h-screen flex flex-col">
        ...
        <x-ingredient-modal title="PRODUCT TOEVOEGEN">
            ...
            <div class="flex flex-wrap gap-2 mb-8">
                @foreach([
                    ['label' => 'MELK',      'cls' => 'bg-[var(--lime)] text-black border-black'],
                    ['label' => 'EIEREN',    'cls' => 'bg-brand text-white border-brand'],
                    ['label' => 'KAAS',      'cls' => 'bg-[var(--lime)] text-black border-black'],
                    ['label' => 'BOTER',     'cls' => 'bg-brand text-white border-brand'],
                    ['label' => 'YOGHURT',   'cls' => 'bg-[var(--lime)] text-black border-black'],
                ] as $sug)
        ...
        function inventaris() {
            return {
                ...
                async addItem() {
                    ...
                    window.dispatchEvent(new CustomEvent('close-ingredient-modal'));
                },
            }
        }
        </script>
