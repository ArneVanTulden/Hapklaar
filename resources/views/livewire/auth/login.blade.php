<div>
    ...
    <form wire:submit="login" class="space-y-5">
        ...
        <button type="submit"
                ...
                class="w-full bg-brand text-white text-[13px] font-black uppercase italic tracking-widest py-4 border-2 border-black shadow-[4px_4px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000] transition-all duration-75 disabled:opacity-60">
            <span wire:loading.remove wire:target="login">INLOGGEN →</span>
            <span wire:loading wire:target="login">LADEN...</span>
        </button>
    ...
    <div class="text-center mt-5">
        <a href="{{ route('forgot-password') }}" class="text-sm font-medium underline underline-offset-2 text-black hover:text-brand transition-colors">
            Wachtwoord vergeten?
        </a>
    </div>
